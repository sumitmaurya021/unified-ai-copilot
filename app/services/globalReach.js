...
export function localizeProductContent({
  ...
  let localizedPriceDisplay = "€99,90 EUR (Inkl. 19% MwSt.)";
  ...
  if (targetMarket === "JAPAN_APAC") {
    ...
    localizedPriceDisplay = "¥12,800 JPY (税込・国内送料無料)";
    ...
    localizedPriceDisplay = "€299,00 EUR (TTC - Livraison Express France)";
    ...
    localizedPriceDisplay = "$2,799 MXN (Hasta 12 meses sin intereses)";
    ...
    localizedPriceDisplay = "£79.99 GBP (Inc. VAT & Next-Day Delivery)";
